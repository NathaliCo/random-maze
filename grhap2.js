...
function createLaberint(puntoDeInicial) {

    for (i = 0; i < 20, i++) {
        let lines = [];
        let nextLine;
        // let valor = Math.random()
        let direcciones = [(Math.random()), (Math.random()), (Math.random()), (Math.random()), (Math.random()), (Math.random()), (Math.random()), (Math.random())]
